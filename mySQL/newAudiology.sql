...
CREATE TABLE IF NOT EXISTS `mydb`.`Audiology` (
  ...
  `right_TRm` VARCHAR(45) NOT NULL,
  `right_TLR` INT NOT NULL,
  `right_ThR` INT NOT NULL,
  `left_TLP` INT NOT NULL,
  `left_TLm` VARCHAR(45) NOT NULL,
  `left_TLL` INT NOT NULL,
  `left_ThL` INT NOT NULL,
  `WNR` INT NOT NULL,
  `WNL` INT NOT NULL,
  `mml_Right` VARCHAR(45) NOT NULL,
  `mml_Left` VARCHAR(45) NOT NULL,
  `RSD` INT NOT NULL,
  `LSD` INT NOT NULL,
  `pt_LDL_Right` INT NOT NULL,
  `pt_LDL_Left` INT NOT NULL,
  `comments` LONGTEXT NOT NULL,
  INDEX `fk_Audiological_Visit_idx` (`Visit_visit_id` ASC) VISIBLE,
  PRIMARY KEY (`Visit_visit_id`),
